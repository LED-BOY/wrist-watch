...
#define SCREEN_RST PORTA.OUT &= ~PIN3_bm;// led ON, also resets the oled screen.
#define SCREEN_ON PORTA.OUT |= PIN3_bm;// led OFF
#define SCREEN_OFF !(PORTA.OUT & PIN3_bm)// screen reset pin low
...
#define ENABLE_WDT  _PROTECTED_WRITE(WDT.CTRLA, WDT_PERIOD_4KCLK_gc);// enable watchdog 4 sec. aprox.
